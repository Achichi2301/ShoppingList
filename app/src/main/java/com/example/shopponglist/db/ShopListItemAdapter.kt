...
import com.example.shopponglist.databinding.ShopLibraryListItemBinding
import com.example.shopponglist.databinding.ShopListItemBinding
        ...
        private fun setPaintFlagAndColor(binding: ShopListItemBinding){
            binding.apply {
                if(chBox.isChecked){
                    ...
                    tvName.setTextColor(ContextCompat.getColor(binding.root.context, R.color.gray_main))
                    tvInfo.setTextColor(ContextCompat.getColor(binding.root.context, R.color.gray_main))
                } else {
