...
import com.example.shopponglist.databinding.NoteListItemBinding
...
class NoteAdapter(private var listener: Listener, private val defPref: SharedPreferences) : ListAdapter<NoteItem, NoteAdapter.ItemHolder>(ItemComparator()) {
